...
for (experiment in levels(RNA_group)){
  x <- (rpkm %>% dplyr::select(dplyr::matches(paste0("flybase_gene_id|",experiment))) %>% dplyr::mutate(sum=rowSums(.[-1]>=5)) %>% dplyr::filter(sum>=2))[1]
...
# write.csv(rpkm_mean %>% dplyr::filter(flybase_gene_id %in% unlist(keep_name)),"L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/RPKM_5_per_genotype.csv",row.names = F)
########## Exploratore graph

rpkm_filtered <- RNA_rpkm %>% dplyr::filter(flybase_gene_id %in% unlist(keep_name))

pdf("L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/Summary_graph_5RPKM_filter.pdf",width = 10,height = 8)
...
pdf("L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/MDS.pdf",width = 10,height = 8,useDingbats=FALSE)
...
pdf("L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/PCA.pdf",width = 10,height = 8)
...
while (x <= ncol(data)){
  ...
  while (y <= ncol(data)){
    ...
    sp <-   ggplot(graph,aes(x=log2(C1),y=log2(C2),label=external_gene_name)) + geom_point(aes(alpha=0.5),size=1) +
      ...
      geom_hline(yintercept = 2.321928, colour = "gray65",size = 0.5, linetype = "dotted") + 
      geom_vline(xintercept = 2.321928, colour = "gray65",size = 0.5, linetype = "dotted") +
    ...
    pdf(paste0("L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/Scatter/",x_genotype,"-",y_genotype,".pdf"),height = 8,width = 10,useDingbats=FALSE)
    print(sp)
    dev.off()
    htmlwidgets::saveWidget(spp, paste0("L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/Scatter/",x_genotype,"-",y_genotype,".html"))
...
write.csv(df1,"L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/Scatter/R_matrix.csv")
write.csv(df,"L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/Scatter/R.csv")
...
while(i<=dim(my.contrasts)[2]){
  ...
  pdf(paste0("L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/MMD/base/",colnames(my.contrasts)[i],".pdf"),width = 10,height = 10,useDingbats=FALSE)
  print(cowplot::plot_grid(vp5,sc5,align = "v",axis = "l",nrow = 2,rel_heights = c(0.2,1)))
  dev.off()
  htmlwidgets::saveWidget(ps5, paste0("L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/MMD/base/",colnames(my.contrasts)[i],".html"))
  
  pdf(paste0("L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/Volcano/base/",colnames(my.contrasts)[i],".pdf"),width = 10,height = 10,useDingbats=FALSE)
  print(Volp)
  dev.off()
  htmlwidgets::saveWidget(pv, paste0("L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/Volcano/base/",colnames(my.contrasts)[i],".html"))
  i=i+1
}

write.csv(DEG_df,"L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/DEG_filter_5RPKM.csv",row.names = T)
rm(list = c("comparison","condition","table","DEG_df","match","mean_rpkm","DEG","mark","sc","sc5","vp","vp5","Volp","ps5","pv"))
...
DEG_df <- read.csv("L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/DEG_filter_5RPKM.csv",header = T)
...
while(i<=dim(my.contrasts)[2]){
  ...
  pdf(paste0("L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/MMD/miRNA/iab4/",colnames(my.contrasts)[i],".pdf"),width = 10,height = 10,useDingbats=FALSE)
  print(cowplot::plot_grid(vp5,sc54,align = "v",axis = "l",nrow = 2,rel_heights = c(0.2,1)))
  dev.off()
  htmlwidgets::saveWidget(ps54, paste0("L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/MMD/miRNA/iab4/",colnames(my.contrasts)[i],".html"))
  
  pdf(paste0("L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/MMD/miRNA/iab8/",colnames(my.contrasts)[i],".pdf"),width = 10,height = 10,useDingbats=FALSE)
  print(cowplot::plot_grid(vp5,sc58,align = "v",axis = "l",nrow = 2,rel_heights = c(0.2,1)))
  dev.off()
  htmlwidgets::saveWidget(ps58, paste0("L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/MMD/miRNA/iab8/",colnames(my.contrasts)[i],".html"))
  
  pdf(paste0("L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/Volcano/miRNA/iab4/",colnames(my.contrasts)[i],".pdf"),width = 10,height = 10,useDingbats=FALSE)
  print(Volp4)
  dev.off()
  htmlwidgets::saveWidget(pv4, paste0("L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/Volcano/miRNA/iab4/",colnames(my.contrasts)[i],".html"))
  
  pdf(paste0("L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/Volcano/miRNA/iab8/",colnames(my.contrasts)[i],".pdf"),width = 10,height = 10,useDingbats=FALSE)
  print(Volp8)
  dev.off()
  htmlwidgets::saveWidget(pv8, paste0("L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/Volcano/miRNA/iab8/",colnames(my.contrasts)[i],".html"))
...
for (name in names(DEG_df_miR)[grep("logFC",names(DEG_df_miR))]){
  ...
  pdf(paste0("L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/ECDF/miRNA/logFC/",comparison,".pdf"),width = 10,height = 10)
  print(
...
for (name in names(RPKM_annotate_miR)[grep("_mean",names(RPKM_annotate_miR))]){
  ...
  pdf(paste0("L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/ECDF/miRNA/RPKM/",name,".pdf"),width = 10,height = 10)
  print(
...
for(percentile in c("DEG_percentile","DEG_iab4_percentile","DEG_iab8_percentile")){
  ...
  for (comp in unique(DEG_per_percentile$Comparison)){
    ...
    if(percentile=="DEG_percentile"){
      pdf(paste0("L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/Percentile/Hth_total/",comp,".pdf"),width = 10,height = 10,useDingbats=FALSE)
      print(graph)
      dev.off()
    } else if(percentile=="DEG_iab4_percentile") {
      pdf(paste0("L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/Percentile/Hth_iab4/",comp,".pdf"),width = 10,height = 10,useDingbats=FALSE)
      print(graph)
      dev.off()
    } else {
      pdf(paste0("L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/Percentile/Hth_iab8/",comp,".pdf"),width = 10,height = 10,useDingbats=FALSE)
      print(graph)
      dev.off()
    }
  }
...
while(i<=dim(my.contrasts)[2]){
  ...
  pdf(paste0("L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/MMD/Hth/Slattery_2011/",colnames(my.contrasts)[i],".pdf"),width = 10,height = 10,useDingbats=FALSE)
  print(cowplot::plot_grid(vp5,sc511,align = "v",axis = "l",nrow = 2,rel_heights = c(0.2,1)))
  dev.off()
  htmlwidgets::saveWidget(ps511, paste0("L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/MMD/Hth/Slattery_2011/",colnames(my.contrasts)[i],".html"))
  
  pdf(paste0("L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/MMD/Hth/Slattery_2013/",colnames(my.contrasts)[i],".pdf"),width = 10,height = 10,useDingbats=FALSE)
  print(cowplot::plot_grid(vp5,sc513,align = "v",axis = "l",nrow = 2,rel_heights = c(0.2,1)))
  dev.off()
  htmlwidgets::saveWidget(ps513, paste0("L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/MMD/Hth/Slattery_2013/",colnames(my.contrasts)[i],".html"))
  
  pdf(paste0("L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/Volcano/Hth/Slattery_2011/",colnames(my.contrasts)[i],".pdf"),width = 10,height = 10,useDingbats=FALSE)
  print(Volp11)
  dev.off()
  htmlwidgets::saveWidget(pv11, paste0("L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/Volcano/Hth/Slattery_2011/",colnames(my.contrasts)[i],".html"))
  
  pdf(paste0("L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/Volcano/Hth/Slattery_2013/",colnames(my.contrasts)[i],".pdf"),width = 10,height = 10,useDingbats=FALSE)
  print(Volp13)
  dev.off()
  htmlwidgets::saveWidget(pv13, paste0("L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/Volcano/Hth/Slattery_2013/",colnames(my.contrasts)[i],".html"))
...
for (name in names(DEG_df_miR)[grep("logFC",names(DEG_df_miR))]){
  ...
  pdf(paste0("L:/dani/RNAseq/Project_09228_B/PDF/01_23_2019/5RPKM/ECDF/Hth/logFC/",comparison,".pdf"),width = 10,height = 10)
  print(
